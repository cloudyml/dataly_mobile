                          ...
                          onTap: (() {
                            ...
                            if (navigateToCatalogueScreen(
                              ...
                              if (course[index]
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => MultiComboCourse(
                               ...
                               if (course[index]
                                ...
                                ComboCourse.comboId.value =
                                    course[index].courseId;
                                     ...
                                     Get.to(() => NewComboCourse(courseName: course[index].courseName,
                                        courses: course[index].courses,
                                      ));
