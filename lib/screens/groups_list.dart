...
class _GroupsListState extends State<GroupsList> {
  ...
  searchForStudentGroupList(String searchValue) async {
    ...
    try {
      FirebaseFirestore.instance
          ...
          .where(
            "student_name",
            isGreaterThanOrEqualTo: searchValue.toString(),
          )
  ...
  _getGroupListData() async {
    ...
    try {
      ...
      var response = await http.post(
          Uri.parse(
              "https://us-central1-cloudyml-app.cloudfunctions.net/CloudyML/groupList"),
          headers: headers,
      ...
      if (listOfGroupListData.length != 0) {
        ...
        try {
          if (groupChatCount["groupChatCount"] != null) {
            snapshot.docs[0].data()["groupChatCount"] =
                groupChatCount["groupChatCount"];
          }
        } catch (err) {
          print("error-----------------");
        }
        listOfGroupListData.insert(
            0, {"data": snapshot.docs[0].data(), "id": snapshot.docs[0].id});
        _streamSink.add(listOfGroupListData);
      }
    });
  }
  ...
  Future getStudentName(
      int index, AsyncSnapshot<List<dynamic>> snapshotGroupList) async {
    await FirebaseFirestore.instance
        .collection('Users_dataly')
        .where('id',
            isEqualTo: snapshotGroupList.data![index]["data"]["student_id"])
        .get()
        .then((value) {
      value.docs.forEach((element) {
        snapshotGroupList.data![index]["data"]["student_name"] =
            element.get('name');
        setState(() {});
      });
    });
                                                            ...
                                                            Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                builder: (_) =>
                                                                    ChatScreen(
                                                                  groupData: {
                                                                    "data": snapshotGroupList
                                                                        .data![
                                                                            index]
                                                                        .data(),
                                                                    "id": snapshotGroupList
                                                                        .data![
                                                                            index]
                                                                        .id
                                                                  },
                                                                  groupId: snapshotGroupList
                                                                      .data![
                                                                          index]
                                                                      .id,
                                                                  userData:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        //       25,
                                                                        //   backgroundImage:
                                                                        //       CachedNetworkImageProvider(snapshotGroupList.data![index]["icon"]),
                                                                        // ),
                                                                      ],
                                                                    ),
                                                                  ),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      userData!["role"] ==
                                                                          ...
                                                                          ? Text(
                                                                              ...
                                                                              style: TextStyle(fontFamily: 'Regular', fontSize: 13, overflow: TextOverflow.ellipsis, height: 0),
                                                                              maxLines: 2,
                                                                            )
                                                                          : userData!["role"] == "councillor"
                                                                              ? SizedBox()
                                                                              : SizedBox()
                                                                    ],
                                                                  )),
                                                                      ...
                                                                      StreamBuilder(
                                                                        ...
                                                                        builder: (BuildContext
                                                                          ...
                                                                          return StreamBuilder(
                                                                            stream:
                                                                                FirebaseFirestore.instance.collection("groups_dataly").doc(snapshotGroupList.data![index].id).collection('chats').where('sendBy', isNotEqualTo: userprovider.userModel!.name).snapshots(),
                                                                            builder:
                                                                                (
                                                                              ...
                                                                              if (snapshot.data != null) {
                                                                                ...
                                                                                if (snapshot.data!.docs.length > documentSnapshot.data!.data()!['groupChatCount'][_auth.currentUser!.uid]) {
                                                                                  return StreamBuilder(
                                                                                          ...
                                                                                          children: [
                                                                                            Column(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                Text(
                                                                                                  "${documentSnapshot.data!.data()!['mentioned'] != null ? documentSnapshot.data!.data()!['mentioned'].length != 0 ? documentSnapshot.data!.data()!['mentioned'].contains(_auth.currentUser!.uid.toString()) ? '@ ' : '' : '' : ''}",
                                                        ...
                                                        .removePadding(
                                                            ...
                                                            child: ListView
                                                              ...
                                                              itemBuilder:
                                                                  (context,
                                                                      index) {
                                                                //  log('Student Name:::: ${snapshotGroupList.data![index]["data"]["student_name"]}');
                                                                getStudentName(
                                                                    index,
                                                                    snapshotGroupList);
                                                                ...
                                                                return GestureDetector(
                                                                  onTap:
                                                                    ...
                                                                    print(
                                                                        "dataaa");
                                                                    if (listOfGroupListData[index]['data']
                                                                            [
                                                                            'groupChatCountNew'] !=
                                                                        null) {
                                                                      listOfGroupListData[index]['data']
                                                                              [
                                                                              'groupChatCountNew']
                                                                          [_auth
                                                                              .currentUser!
                                                                      ...
                                                                      _streamSink
                                                                          .add(
                                                                              listOfGroupListData);
                                                                      updateNotificationCountToZero(
                                                                          listOfGroupListData[index]
                                                                              [
                                                                              'id']);
                                                                    }
                                                                    print(snapshotGroupList
                                                                            .data![
                                                                        index]);
                                                                      ...
                                                                      MaterialPageRoute(
                                                                        builder:
                                                                          ...
                                                                          groupData:
                                                                              snapshotGroupList.data![index],
                                                                          groupId:
                                                                              snapshotGroupList.data![index]["id"],
                                                                          userData:
                                                                              userData,
                                                                        ),
                                                                      ),
                                                                    ...
                                                                    await _firestore
                                                                        .collection(
                                                                            'groups_dataly')
                                                                        .doc(snapshotGroupList.data![index]
                                                                            [
                                                                            "id"])
                                                                        .collection(
                                                                            'chats')
                                                                      ...
                                                                      await _firestore
                                                                          ...
                                                                          .doc(snapshotGroupList.data![index]
                                                                              ...
                                                                              "id"])
                                                                          .update({
                                                                        'groupChatCount.${_auth.currentUser!.uid}': value
                                                                            .docs
                                                                            .length,
                                                                        "mentioned":
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                // CircleAvatar(
                                                                                //   radius: 25,
                                                                                //   backgroundImage: CachedNetworkImageProvider(snapshotGroupList.data![index]["data"]["icon"]),
                                                                                // ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                                ...
                                                                                children: [
                                                                                  Column(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Text(
                                                                                        "${snapshotGroupList.data![index]['mentioned'] != null ? snapshotGroupList.data![index]['mentioned'].length != 0 ? snapshotGroupList.data![index]['mentioned'].contains(_auth.currentUser!.uid.toString()) ? '@ ' : '' : '' : ''}",
                                                                                        style: TextStyle(color: HexColor("31D198"), fontWeight: FontWeight.bold, fontSize: 17),
                                                                                      ),
                                                                                    ],
                                                                                  ),
                                                                                  Column(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      snapshotGroupList.data![index]['data']['groupChatCountNew'] != null
                                                                                          ? snapshotGroupList.data![index]['data']['groupChatCountNew'][_auth.currentUser!.uid] != 0 && snapshotGroupList.data![index]['data']['groupChatCountNew'][_auth.currentUser!.uid] != null
                                                                                              ? Text("${(snapshotGroupList.data![index]["data"]["time"].runtimeType.toString() == "Timestamp") ? DateTimeFormatNotification(snapshotGroupList.data![index]["data"]["time"].toDate().toString()) : DateFormat.jm().format(Timestamp(snapshotGroupList.data![index]['data']["time"]["_seconds"], snapshotGroupList.data![index]['data']["time"]["_nanoseconds"]).toDate()).toString()}",
                                                                                                  ...
                                                                                                  style: TextStyle(fontSize: 6, fontFamily: "Regular", fontWeight: FontWeight.bold, color: HexColor("7A7A7C")),
                                                                                                  overflow: TextOverflow.ellipsis)
                                                                                              : SizedBox()
                                                                                          : SizedBox(),
                                                                    ...
                                                                    return GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        await _firestore
                                                                            ...
                                                                            .doc(snapshotGroupList.data!.docs[index].id)
                                                                            .collection('chats')
                                                                            .where('sendBy', isNotEqualTo: userprovider.userModel!.name)
                                                                            .get()
                                                                            .then((value) async {
                                                                          await _firestore
                                                                              .collection("groups_dataly")
                                                                              ...
                                                                              child: Container(
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                    // CircleAvatar(
                                                                                    //   radius: 25,
                                                                                    //   backgroundImage: CachedNetworkImageProvider(snapshotGroupList.data!.docs[index]["icon"]),
                                                                                    // ),
                                                                                  ],
                                                                                ),
                                                                              ),
                                                                            ...
                                                                            Expanded(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  //   child:
                                                                                  StreamBuilder(
                                                                                    stream: FirebaseFirestore.instance.collection("groups_dataly").doc(snapshotGroupList.data!.docs[index].id).snapshots(),
                                                                                    builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot<Map<String, dynamic>>> documentSnapshot) {
                                                                                      return StreamBuilder(
                                                                                        stream: FirebaseFirestore.instance.collection("groups_dataly").doc(snapshotGroupList.data!.docs[index].id).collection('chats').where('sendBy', isNotEqualTo: userprovider.userModel!.name).snapshots(),
                                                                                        builder: (
                                                                                          BuildContext context,
                                                                                          AsyncSnapshot<QuerySnapshot> snapshot,
                                                                                        ) {
                                  ...
                                  child: StreamBuilder(
                                      ...
                                      builder: (context,
                                          AsyncSnapshot<QuerySnapshot>
                                              snapshot) {
                                        if (snapshot.hasData) {
                                          print(snapshot.data!.docs[0]["Note"]);
                                          return snapshot.data!.docs[0]["Note"]
                                                      .length !=
                                                  0
                                              ? Container(
                                                  width: width,
