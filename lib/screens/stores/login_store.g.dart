...
mixin _$LoginStore on LoginStoreBase, Store {
  ...
  final _$emailAsyncAction = AsyncAction('email');

  final _$signuppassword = AsyncAction("password");

  @override
  Future<void> email(BuildContext context, String email) {
    return _$emailAsyncAction.run(() => super.email(context, email));
  }

  @override
  Future<void> password(BuildContext context, String password,String password2, String email) {
    return _$signuppassword
        .run((() => super.password(context, password, password2, email)));
  }
