      ...
      children: [
        InkWell(
          onTap: () => Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => ImagePage(file: file.toString()),
            ),
          ),
          child: solidBorder(
            child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Image(
                    image: NetworkImage(
                        'https://firebasestorage.googleapis.com/v0/b/cloudyml-app.appspot.com/o/Assets%2Fa1.png?alt=media&token=6fe2910f-9770-4110-9dc8-0aebe04c2f12'),
                    height: 225,
                    width: 350,
                    fit: BoxFit.fill),
              ],
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                backgroundImage: NetworkImage(
                                    'https://firebasestorage.googleapis.com/v0/b/cloudyml-app.appspot.com/o/Assets%2Fuser.jpg?alt=media&token=509ece41-44f9-4267-acbe-6578f956afdc'),
                              ),
                              SizedBox(
                                height: height * 0.01,
                              ),
