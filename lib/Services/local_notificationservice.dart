...
class LocalNotificationService {
  ...
  static display(RemoteMessage message, courseName, id, count) async {
    try {
      ...
      const NotificationDetails notificationDetails = NotificationDetails(
        android: AndroidNotificationDetails("CloudyML", "CloudyMLchannel",
      ...
      await _notificationsPlugin.show(
        ...
        //.toString()+"    "+count.toString()+NewMessage
        ,
  ...
  static void createanddisplaynotificationmessage(
  ...
  static Future showNotificationfromApp({
    int id = 0,
    String? title,
    String? body,
    String? payload,
    ...
    return _notificationsPlugin.show(
        id, title, body, await notificationDetailslocal(),
        payload: payload);
  }
