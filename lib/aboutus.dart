...
class AboutUs extends StatelessWidget {
              ...
              children: [
                Stack(
                  ...
                  children: const [
                    Image(
                      ...
                      // fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://firebasestorage.googleapis.com/v0/b/cloudyml-app.appspot.com/o/Assets%2Fabout_us.png?alt=media&token=c18e3d5e-fd6b-4bdc-83c5-1321110daa72'),
                    ),
                    Positioned(
                      bottom: -50.0,
                      right: 40,
                      child: CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                            'https://firebasestorage.googleapis.com/v0/b/cloudyml-app.appspot.com/o/Assets%2Fimage01.jpg?alt=media&token=ed0fc35b-c231-47f0-8bba-6ddf36b9460a'),
                      ),
                    ),
                  ],
                ),
                ...
                Container(
                    ...
                    child: const Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Text(
                        'Currently, I am working with Tredence Inc. as a Data Scientist for the AI CoE (Center of Excellence) team. Here I work on challenging R&D projects and building various PoCs for winning new client projects for the company.',
                        style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.bold,
                            color: Colors.black),
  ...
  void _linkedInUrl() async {
    if (!await launch(_linkedin as String)) throw 'Could not launch $_linkedin';
  }

  void _instagramUrl() async {
    if (!await launch(_instagram as String))
      throw 'Could not launch $_instagram';
  }

  void _facebookUrl() async {
    if (!await launch(_facebook as String)) throw 'Could not launch $_facebook';
  }

  void _youtubeUrl() async {
    if (!await launch(_youtube as String)) throw 'Could not launch $_youtube';
  }

  void _telegramUrl() async {
    if (!await launch(_telegram as String)) throw 'Could not launch $_telegram';
  }
}
