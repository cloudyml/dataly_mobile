...
import 'package:dataly_app/MyAccount/ChangeEmail.dart';
import 'package:dataly_app/MyAccount/ChangePassword.dart';
import 'package:dataly_app/MyAccount/PhoneVerify.dart';
...
class _EditProfilePageState extends State<EditProfilePage> {
                            ...
                            onPressed: () async{
                              ...
                              if(_formKey.currentState!.validate()){
                                ...
                                if(_image!=null){
                                  ...
                                  UploadTask task =storage.ref().child('Users_dataly/${picture}').putFile(_imagep);
  ...
  _displayChild() {
      ...
      if(_image==null){
          ...
          NetworkImage('https://firebasestorage.googleapis.com/v0/b/cloudyml-app.appspot.com/o/Assets%2Fuser.jpg?alt=media&token=509ece41-44f9-4267-acbe-6578f956afdc'):NetworkImage(userprovider.userModel?.image??'');
      }else{
