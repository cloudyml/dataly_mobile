...
// }
  ...
  getCurrencyRate({required String currency}) {
    try {
      FirebaseFirestore.instance
        ...
        print(
            'currencyRate $currencyRate additionToPayment :: $additionToPayment');
        countFinalAmount();
      });
    } catch (e) {
  ...
  countFinalAmount() {
    print('Indian Price :: ${double.parse(widget.amountString) / 100}');
    finalAmount = ((((double.parse(widget.amountString).round()) / 100) /
                double.parse(currencyRate)) +
